...
export function SamplePost({
  ...
  return (
    <>
    {/*max-w-[1095px]*/}
    <Card className="w-full max-w-2xl mx-auto rounded-[2rem] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]">
        ...
        <div className="p-4 border-t">
                <div className="flex items-center justify-between w-full ">
                  <div className="flex items-center gap-2">
                    ...
                    <Button variant="ghost" size="icon" onClick={toggleComments} className="">
