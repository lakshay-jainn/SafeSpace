...
import { MessageCircle, Heart, Send, ChevronLeft, ThumbsUp,MessageSquareText } from "lucide-react"
        ...
        <div className="p-4 border-t">
                <div className="flex items-center justify-between w-full ">
                  <div className="flex items-center gap-5">
                    ...
                    <Button variant="ghost" size="icon" onClick={toggleComments} className="hover:bg-inherit w-full h-full text-start">
